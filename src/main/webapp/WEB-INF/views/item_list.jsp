        ...
        <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <p class="navbar-text navbar-right">
                        ...
                        <a href="${pageContext.request.contextPath}/logout/sessionInvalidate" class="navbar-link">注文履歴</a>&nbsp;&nbsp;
            ...
            <div class="col-lg-offset-3 col-lg-6 col-md-offset-2 col-md-8 col-sm-10 col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title">商品を検索する
                        </div>
                    </div>
                    <div class="panel-body">
                        <form action="${pageContext.request.contextPath}/item/search" method="post" action="#" class="form-horizontal">
                            <div class="form-group">
                                <label for="code" class="control-label col-sm-2">商品名</label>
                                <div class="col-sm-9"> <input type="text" name="code" id="code" class="form-control input-sm" />
                                </div>
                            </div>
                            <div>
                        ...
                        <tr>
                            <c:forEach var="itemList" items="${itemList}">
                                <th>
                                    ...
                                    <br>
                                    <a href="${pageContext.request.contextPath}/item/show/${itemList.id}">
                                    <c:out value="${itemList.name}" /> </a> <br> 数量 :
                                    <c:out value="${itemList.piece}" />パック <br> 原産地 :
                                    <c:out value="${itemList.origin}" /> <br> </th>
                            </c:forEach>
                        </tr>
                    </tbody>
                </table>
